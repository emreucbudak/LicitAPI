...
public static class AuthLoginTwoFactorEmailTemplate
{
    ...
    public static string BuildBody(AuthLoginTwoFactorEmailEvent emailEvent)
    {
        ...
        body.AppendLine("    <p>Giris isleminizi tamamlamak icin asagidaki 6 haneli dogrulama kodunu kullanin:</p>");
        ...
        body.AppendLine("    <p>Eger bu talebi siz baslatmadiysaniz bu e-postayi yok sayabilirsiniz.</p>");
        body.AppendLine("  </div>");
