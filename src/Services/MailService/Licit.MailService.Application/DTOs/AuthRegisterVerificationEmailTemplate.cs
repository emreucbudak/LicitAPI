...
{
    public static string BuildSubject() => "Licit kayıt doğrulama kodunuz";
    ...
    public static string BuildBody(AuthRegisterVerificationEmailEvent emailEvent)
    {
        ...
        body.AppendLine("    <p>Licit hesabınızı etkinleştirmek için aşağıdaki 6 haneli kayıt doğrulama kodunu kullanın:</p>");
        ...
        body.AppendLine("    <p>Bu kayıt işlemini siz başlatmadıysanız bu e-postayı yok sayabilirsiniz.</p>");
        body.AppendLine("  </div>");
