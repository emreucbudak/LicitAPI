...
using Licit.AuthService.Application.Features.CQRS.Auth.Queries.GetProfile;
...
using Licit.AuthService.Application.Features.CQRS.Auth.Commands.UpdateProfile;
